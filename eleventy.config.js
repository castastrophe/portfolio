...
export default async function ( config ) {
	...
	const CONTENT_DIRS = [ 'posts', 'proposals', 'presentations' ];
	...
	config.addFilter( "validateURL", filters.validateURL );
