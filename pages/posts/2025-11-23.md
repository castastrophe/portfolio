...
tags: web-components, performance, tooling
...
> In this and following examples, <code class="language-javascript">this.localName</code> represents a property on the web component that stores it's tag name, i.e., `custom-button`.
