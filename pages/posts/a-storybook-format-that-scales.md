...
This suggestion is mostly for projects shipping vanilla HTML, CSS, and JavaScript without a framework. If you're building for [React](https://react.dev), [Vue](https://vuejs.org), or [Angular](https://angular.dev), what rendering engine you use will be dictated by the framework.
...
Pick a clear, human-readable title that reflects your component hierarchy. If your folder structure maps to how you want to group components in the sidebar, you can use a [configuration object](https://storybook.js.org/docs/api/main-config/main-config-stories#with-an-array-of-globs) in your configuration file (`.storybook/main.js`):
